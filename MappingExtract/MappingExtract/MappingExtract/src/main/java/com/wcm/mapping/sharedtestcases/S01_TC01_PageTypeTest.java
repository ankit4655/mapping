...
//    	WebElement loadProject = driver.findElement(By.xpath("//select[@id=\"projectList\"]/optgroup[@label=\"Active Projects\"]/option[@value=\"001_VAIBHAV_TEST\"]"));
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(TestUtil.FUZE_IMPLICIT_WAIT));
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(180));
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//select//optgroup[@label=\"Active Projects\"]//option[@value=\"001_VAIBHAV_TEST\"]"))));
		driver.findElement(By.xpath("//select//optgroup[@label=\"Active Projects\"]//option[@value=\"001_VAIBHAV_TEST\"]")).click();
		...
		String defaultpath = driver.findElement(By.xpath("//span[@class=\"fuze-metaDataWarningMessageText\"]")).getText();
		System.out.println(defaultpath);
		String updateddefaultpath = defaultpath.substring(6, defaultpath.length());
		System.out.println(updateddefaultpath);
		driver.quit();
		return updateddefaultpath;
//		if(count>2)
//		{
