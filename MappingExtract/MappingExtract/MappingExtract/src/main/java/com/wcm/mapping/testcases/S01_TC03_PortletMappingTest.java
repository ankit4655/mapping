...
public class S01_TC03_PortletMappingTest extends TestBase {
	...
	@Test
	public String portletMappingTest(String excelTemplate , String mappingExtract) throws IOException
	{
		int m = 0;
		...
		for(i=0; i<portletMappingList.size();i++)
		{
		 ...
		 if(portletMappingList.size() == set1.size())
		 {
		    ...
		    System.out.println("Portlet Mapping: "+fuzePageLevelMp + " [DPL-SiteArea]");
            return "Portlet Mapping: "+ fuzePageLevelMp +" [DPL-SiteArea]";
		 }
		 else
		 {
